...
**AWS** was the cloud provider of choice, we [deployed](/prediction_example/app.py) the model using **ECS Fargate**. The model was wrapped in a **FastAPI** application, containerized with **Docker**, and pushed to **Amazon ECR**.
